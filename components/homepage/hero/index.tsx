...
const Hero = () => {
    return (
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 to-pink-100">
            <div className="mx-auto px-4 py-10 max-w-[85rem] sm:px-6 sm:py-24 lg:px-8">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-gray-800 text-balance sm:text-6xl">
                        Find your new <span
                        className='relative lg:rounded-md lg:bg-primary/20 lg:text-gray-900 lg:px-4'>best friend</span>
                    </h1>
                    ...
                    <div className="mt-8 text-center sm:flex sm:items-center sm:justify-center sm:text-start">
                        <div className="flex-shrink-0 pb-5 sm:pe-5 sm:flex sm:pb-0">
                            {/* Avatar Group */}
                            <div className="flex justify-center -space-x-3">
                                <Image src='/hero-pets/cat.jpg' width='100' height='100'
                                       className='inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white'
                                       alt='My Image'/>
                                <Image src='/hero-pets/dogs.jpg' width='100' height='100'
                                       className='inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white'
                                       alt='My Image'/>
                                <Image src='/hero-pets/reptiles.jpg' width='100' height='100'
                                       className='inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white'
                                       alt='My Image'/>
                                <Image src='/hero-pets/birds.jpg' width='100' height='100'
                                       className='inline-block h-10 w-10 rounded-full object-cover ring-2 ring-white'
                                       alt='My Image'/>
                                <span
                                    className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gray-800 ring-2 ring-white">
            <span className="text-xs font-medium uppercase leading-none text-white">1k+</span>
          </span>
                            </div>
                            {/* End Avatar Group */}
                        </div>
                        ...
                        <div
                            className="mx-auto h-px w-32 border-t border-gray-200 dark:border-gray-700 sm:border-s sm:mx-0 sm:h-full sm:w-auto sm:border-t-0"></div>
                    ...
                    <div className="relative mx-auto mt-7 max-w-xl sm:mt-12">
                        ...
                        <form>
                            <div
                                className="relative z-10 flex rounded-lg border bg-white p-3 shadow-lg space-x-3 shadow-gray-100/[.2]">
                                ...
                                <div className="flex-[0_0_auto]">
                                    <a
                                        className="inline-flex items-center justify-center gap-x-2 rounded-lg border border-transparent bg-blue-600 text-sm font-semibold text-white w-[46px] h-[46px] hover:bg-blue-700 disabled:pointer-events-none disabled:opacity-50"
                                        href="#"
                                    >
                                        <svg
                        ...
                        {/* SVG Element */}
                        <div className="absolute top-0 hidden translate-x-16 -translate-y-12 end-0 md:block">
                            <svg className="h-auto w-16 text-orange-500" width="121" height="135" viewBox="0 0 121 135"
                                ...
                                <path d="M33.6761 112.104C44.6984 98.1239 74.2618 57.6776 83.4821 5"
                                      stroke="currentColor" strokeWidth="10" strokeLinecap="round"></path>
                        ...
                        {/* SVG Element */}
                        <div className="absolute bottom-0 hidden -translate-x-32 translate-y-10 start-0 md:block">
